...
if (isset($_SESSION['user'])) {
  if (isset($_POST['id'])) {
    ...
    $statement = $pdo->prepare('SELECT user_id, post_id FROM likes WHERE user_id = :uid AND post_id = :pid');
    ...
    $statement = $pdo->prepare('SELECT id, likes FROM posts WHERE id = :pid');
    $statement->bindParam(':pid', $postId, PDO::PARAM_STR);
    $statement->execute();
