...
if (isset($_SESSION['user'])) {
  ...
  $query = 'SELECT posts.id, posts.content, posts.description FROM followings INNER JOIN users ON followings.followed_user_id = users.id INNER JOIN posts ON followings.followed_user_id = posts.user_id WHERE followings.follower_user_id = :id ORDER BY posts.id DESC';
